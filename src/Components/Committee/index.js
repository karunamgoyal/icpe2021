                ...
                <div>
                    ...
                    <div className="organizingCommittee">
                        ...
                        <div className="chairPerson">
                            ...
                            <div className="cardChair">
                                <Card src={"https://i1.rgstatic.net/ii/profile.image/385824081367043-1468999037967_Q128/Ashvini_Chaturvedi.jpg"} name="Dr. Ashvini Chaturvedi" designation="Prof. ECE Department, National Institute of Technology, Surathkal" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="organizingSecretary">
                        ...
                        <div className="chairPerson">
                            ...
                            <div className="cardChair">
                                <Card src={"https://nitkkr.ac.in/admin/member_images/1574853404IMG_20191127_165543.jpg"} name="Dr. N. P. Singh" designation="Associate Prof. ECE Department, NIT, Kurukshetra" />
                            </div>
                        </div>
                    </div>
                    <div className="ChiefPatron">
